    ...
    <>
      ...
      <div className={classes.eventmaindiv}>
        ...
        <div className={classes.eventcontentdiv}>
          <h1>MASTERS' <span>TALK</span></h1>
          <h3>A Guide for further studies from seniors who have secured themselves a seat in top universities all over the world and India. he talk will be about They will guide students about how to start preparation</h3>
          <Link href="events">
